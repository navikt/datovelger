...
var DomEventContainer = /** @class */function (_super) {
    ...
    DomEventContainer.prototype.render = function () {
        ...
        return React.createElement("div", __assign({ ref: function (c) {
            ...
            } }, propsRest, { onBlur: this.handleBlur, onKeyDown: this.handleInternalDocumentKeyDown, tabIndex: this.props.tabIndex }), this.props.children);
    };
