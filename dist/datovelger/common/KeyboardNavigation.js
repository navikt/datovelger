...
var KeyboardNavigation = function (props) {
    return React.createElement(KeyboardActions_1.KeyboardActions, { actions: (props.onEnter ? [enterAction(props.onEnter)] : []).concat(props.onEscape ? [escapeAction(props.onEscape)] : [], props.onArrowUp ? [arrowUpAction(props.onArrowUp)] : [], props.onArrowDown ? [arrowDownAction(props.onArrowDown)] : [], props.onArrowLeft ? [arrowLeftAction(props.onArrowLeft)] : [], props.onArrowRight ? [arrowRightAction(props.onArrowRight)] : [], props.onPageUp ? [pageUpAction(props.onPageUp)] : [], props.onPageDown ? [pageDownAction(props.onPageDown)] : [], props.onAltPageUp ? [altPageUpAction(props.onAltPageUp)] : [], props.onAltPageDown ? [altPageDownAction(props.onAltPageDown)] : [], props.onHome ? [homeAction(props.onHome)] : [], props.onEnd ? [endAction(props.onEnd)] : []) }, props.children);
};
