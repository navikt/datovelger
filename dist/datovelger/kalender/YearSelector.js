...
var YearSelector = /** @class */function (_super) {
    ...
    YearSelector.prototype.render = function () {
        ...
        return React.createElement("div", { className: "nav-datovelger__yearSelector" }, showYearSelect && React.createElement("div", { className: "selectContainer" }, React.createElement("label", { className: "sr-only", htmlFor: yearSelectId }, "Velg \u00E5r"), React.createElement("select", { id: yearSelectId, ref: function (c) {
                return _this.yearSelect = c;
            }, className: "skjemaelement__input skjemaelement__input--year", name: "year", onChange: this.onYearChange, value: defaultMonth.getFullYear() }, years.map(function (year) {
            return React.createElement("option", { key: year, value: year }, year);
        }))), React.createElement("div", { className: "selectContainer" + (showYearSelect === false ? ' selectContainer--monthOnly' : '') }, React.createElement("label", { className: "sr-only", htmlFor: mndSelectId }, "Velg m\u00E5ned"), React.createElement("select", { id: mndSelectId, ref: function (c) {
                return _this.monthSelect = c;
            }, className: "skjemaelement__input", name: "month", onChange: this.onChange, value: defaultMonth.getMonth() }, monthOptions.map(function (m) {
