...
describe('DatoInput', () => {
    ...
    it('Should be blank initially', () => {
        const component  = shallow(<Datoinput selectedDate={undefined} onDateChange={jest.fn()} />);
    ...
    it('ISO formatted selectedDate prop should render in DD.MM.YYYY format', () => {
        const component  = shallow(<Datoinput selectedDate={'2019-01-01'} onDateChange={jest.fn()} />);
    ...
    it('Should not render invalid date string', () => {
        const component  = shallow(<Datoinput selectedDate={'40-30-2019'} onDateChange={jest.fn()} />);
    ...
    it('Should return invalid date string if selected date does not exist', () => {
        const onDateChangeMock = jest.fn();
        const component  = shallow(<Datoinput selectedDate={'40-30-2019'} onDateChange={onDateChangeMock} />);
